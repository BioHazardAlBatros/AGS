...
void display()
{
	...
	char temp[100];
	sprintf_s(temp, "Lab7 FPS[%d] %s [%d matSwaps] [%d texSwaps] [%d drawcalls]", getFPS(),Demo.getSceneDescription().c_str(),renderMan.materialSwaps,renderMan.textureSwaps,renderMan.drawCalls);
